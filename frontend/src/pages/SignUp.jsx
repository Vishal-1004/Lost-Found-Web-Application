...
const SignUp = () => {
  ...
  return (
    <div className="signup-area flex justify-center items-center pt-[80px] sm:pt-[50px] pb-[50px] max-w-8xl pe-0">
      <div className="box">
        ...
        <form
          name="signup-form"
          className="w-full mx-10 pe-3"
          onSubmit={handleSubmit(onSubmit)}
          noValidate
        >
          <div className="mb-3 w-full pe-10">
            <label
          ...
          <div className="mt-3 text-center me-10 pe-4">
            <button
              type="submit"
