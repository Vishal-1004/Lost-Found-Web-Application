  ...
  return (
    <div className='w-screen flex  shadow-lg justify-between items-center p-4'>
        ...
        <div className='hidden md:flex items-center gap-4'>
            ...
            {response.loggedIn && !response.imgURL &&
                <div onClick={()=>setProfileClicked(!profileClicked)}>
                    <img className='h-[6vh] cursor-pointer border-2 p-1 rounded-full  border-gray-400' src="https://avatar.iran.liara.run/public/boy?username=Ash" />
                </div>
            }
        ...
        <div className='flex md:hidden items-center gap-4'>
            ...
            {!response.loggedIn && 
            <div>
                <button onClick={()=>setProfileClicked(!profileClicked)} className=' cursor-pointer border-2 py-2 px-4 font-semibold rounded text-[1.2rem] hover:bg-gray-900/10 active:bg-gray-900/20 border-gray-300' > <FontAwesomeIcon icon={faBars} /> </button>
            </div>}
            {!profileClicked && 
                <ul className='flex absolute top-[12%] right-5 p-2  flex-col justify-center bg-white shadow-lg gap-2'>
                    ...
                    {response.loggedIn && <Link className='px-4 py-2 text-[1.2rem] font-bold rounded hover:bg-gray-900/10 active:bg-gray-900/20 flex gap-2 items-center justify-between disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none' to="/"><li><FontAwesomeIcon icon={faArrowRightFromBracket} /> Log Out</li></Link>}
                    {!response.loggedIn && <Link className='px-4 py-2 text-[1.2rem] font-bold rounded hover:bg-gray-900/10 active:bg-gray-900/20 flex gap-2 items-center justify-between disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none' to="/"><li><FontAwesomeIcon icon={faArrowRightToBracket} /> Log In</li></Link>}
                </ul> 
            }
        </div>
    </div>
