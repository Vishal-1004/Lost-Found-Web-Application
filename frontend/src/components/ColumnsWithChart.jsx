...
const ColumnsWithChart = () => {
  return (
    <div className="mx-auto sm:px-12 py-8 bg-gradient-to-b from-[#fff] to-blue-100">
      <div className="flex flex-wrap items-center">
        <div className="w-full md:w-1/2 px-4 flex flex-col gap-4 mb-4">
          <h1
            className="text-[28px] md:text-[33px] lg:text-[36px] font-bold text-gray-700 text-left"
          >
            Some Information
          </h1>
